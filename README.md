[![Build status](https://ci.appveyor.com/api/projects/status/mu8cksg2uy1ntlh1/branch/master?svg=true)](https://ci.appveyor.com/project/MaksD88/patterns-2/branch/master)
...
* время, затраченное на автоматизацию (минут): ≈ 400 минут.
